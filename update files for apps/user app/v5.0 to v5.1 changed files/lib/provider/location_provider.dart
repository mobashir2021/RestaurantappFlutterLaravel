...
class LocationProvider with ChangeNotifier {
  ...
  // update Position
  void updatePosition(CameraPosition position, bool fromAddress, BuildContext context) async {
  ...
  Future<String> getAddressFromGeocode(LatLng latLng, BuildContext context) async {
    ...
    if(response.response.statusCode == 200 && jsonDecode(response.response.data)['status'] == 'OK') {
      _address = jsonDecode(response.response.data)['results'][0]['formatted_address'].toString();
    }else {
